...
def main():
    ...
    main_parser.add_argument('--batch_size', type=int, default=4096)
    main_parser.add_argument('--num_epochs', type=int, default=1000)
    main_parser.add_argument('--lr_freq', type=int, default=100)
    main_parser.add_argument('--loss_weight', default=True) ### !!choose for run!! ###  
    
    
    ######### dataset variables #########
    main_parser.add_argument('--noise_level_range', default= [1, 3 * 255])
    # main_parser.add_argument('--quadratic_noise', default = False) 
    # main_parser.add_argument('--cosine_mid', default = False) 
    main_parser.add_argument('--sigma_dist', default = 'uniform' )     
    ...
    main_parser.add_argument('--data_name', type=str , default = 'texture_EPS_color')  ### !!choose for run!! ###  
    ...
    main_parser.add_argument('--optional_dir_label', default='color_no_skip_deep_dec_weightedLoss', help='will be added to denoiser type when building dir name') ### choose for run ###  
    ...
    if main_args.arch_name== 'UNet_flex': 
        ...
        parser.add_argument('--num_enc_conv', default= [2,2,2], help='min is 2')  
        parser.add_argument('--num_mid_conv', default= 3, help='min is 2')  
        parser.add_argument('--num_dec_conv', default= [5,6,7], help='min is 2') 
        parser.add_argument('--NormType', default= 'LayerNorm') ## choose for run
    ...
    ######### adjust lr and epochs for small train sets #########
    # args.num_epochs = args.num_epochs * int(194000/args.set_size) ### !!choose for run!! ### 
    # args.lr_freq = args.lr_freq * int(194000/args.set_size) ### !!choose for run!! ### 
    ...
    #     model.module.save_activations_means = True    
    #     args.lambda_l1 = 1/args.SLURM_ARRAY_TASK_ID
    #     args.optional_dir_label = args.optional_dir_label + str(args.SLURM_ARRAY_TASK_ID)
